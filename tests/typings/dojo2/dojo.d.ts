...
declare module 'intern/dojo/interfaces' {
...
declare module 'intern/dojo/aspect' {
	import core = require('intern/dojo/interfaces');
...
declare module 'intern/dojo/Evented' {
	import core = require('intern/dojo/interfaces'); class Evented {
...
declare module 'intern/dojo/on' {
	import core = require('intern/dojo/interfaces');
	import Evented = require('intern/dojo/Evented'); module on {
...
declare module 'intern/dojo/CallbackQueue' {
	import core = require('intern/dojo/interfaces'); class CallbackQueue<T extends Function> {
	    private _callbacks;
...
declare module 'intern/dojo/loader' {
...
declare module 'intern/dojo/has' {
	import loader = require('intern/dojo/loader'); module has {
	    interface IHas {
	        (name: string): any;
...
declare module 'intern/dojo/nextTick' {
	import core = require('intern/dojo/interfaces'); var nextTick: (callback: () => void) => core.IHandle;
	export = nextTick;

}
declare module 'intern/dojo/kernel' {
...
declare module 'intern/dojo/DateObject' {
	import core = require('intern/dojo/interfaces'); class DateObject implements core.IDateObject {
...
declare module 'intern/dojo/io-query' {
	/**
	 * @module intern/dojo/io-query
	 *
...
declare module 'intern/dojo/string' {
...
declare module 'intern/dojo/cookie' {
...
declare module 'intern/dojo/Registry' {
	import core = require('intern/dojo/interfaces'); module Registry {
	    interface ITest {
	        (...args: any[]): boolean;
	    }
...
declare module 'intern/dojo/request' {
	...
	import Registry = require('intern/dojo/Registry'); module request {
...
declare module 'intern/dojo/request/xhr' {
	import Promise = require('intern/dojo/Promise');
	import request = require('intern/dojo/request'); module xhr {
...
declare module 'intern/dojo/request/node' {
	import Promise = require('intern/dojo/Promise');
	import request = require('intern/dojo/request'); module node {
...
declare module 'intern/dojo/Scheduler' {
	import core = require('intern/dojo/interfaces'); class Scheduler {
...
declare module 'intern/dojo/Observable' {
	import core = require('intern/dojo/interfaces'); class Observable implements core.IObservable {
	    private _callbacks;
...
declare module 'intern/dojo/ObservableProperty' {
	import core = require('intern/dojo/interfaces');
	import Observable = require('intern/dojo/Observable'); class ObservableProperty<T> extends Observable {
	    private _observable;
...
declare module 'intern/dojo/domReady' {
	import loader = require('intern/dojo/loader');
...
declare module 'intern/dojo/text' {
	import loader = require('intern/dojo/loader');
	export function load(resourceId: string, require: loader.IRequire, load: (value?: any) => void): void;

}
declare module 'intern/dojo/on/once' {
	import on = require('intern/dojo/on'); function once(type: string): on.IExtensionEvent;
	export = once;

}
declare module 'intern/dojo/on/pausable' {
	import core = require('intern/dojo/interfaces');
	import on = require('intern/dojo/on'); module pausable {
...
declare module 'intern/dojo/ObservableArray' {
	import core = require('intern/dojo/interfaces'); class ObservableArray<T> implements core.IObservableArray<T> {
	    [index: number]: T;
	    length: number;
...
declare module 'intern/dojo/dom' {
